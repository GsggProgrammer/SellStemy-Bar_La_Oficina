...
if ($_POST['boton'] == 'consultaEliminados'){
    ...
    if (!empty ($r)){
        ...
        <!DOCTYPE html>
            <html lang="es">
                <head>
                    ...
                    <div class="row">
                      <div class="col-2">
                       <a href="../vista/VProducto.html" class="btn btn-outline-dark mr-auto volver">
                        <i class="fas fa-arrow-left"></i> <span>Volver</span>
                       </a>
                      </div>
                      <div class="col-8">
                       <h1> Restaurar Productos Bar-LaOficina </h1>
                      </div>
                      <div class="col-2">
                                ...
                                <?php
                                    foreach($r as $valor){
                                        echo "<tr>
                                            ...
                                            <td><a class='btn btn-outline-success' style='border: 2px solid green;' href='CProducto.php?boton=reactivarProducto&doc=$valor[ID]'> Restaurar </a>";
                                    }
                                ?>
                            </table>
                        </section>
      ...
      function cerrarSesion() {
        ...
        echo "<script>
        alert('No hay productos eliminados');
